    ...
    public function __construct(&$data)
    {
        ...
        if ($length == 255) {
            ...
            if (strlen($data) > 0 && ord($data{0}) == $this->type) {
                ...
                $this->value .= (new TLV8($data))->getValue();
            }
        }
...
class TLVBuilder {
    ...
    static private function Base ($type, $value) {
    ...
    static public function Identifier($identifier) {
        return self::Base(TLVType::Identifier, $identifier);
    }

    static public function Salt($salt) {
        return self::Base(TLVType::Salt, $salt);
    }

    static public function PublicKey($publicKey) {
        $response = "";
    ...
    static public function Proof($proof) {
        return self::Base(TLVType::Proof, $proof);
    }

    static public function EncryptedData($encryptedData) {
        return self::Base(TLVType::EncryptedData, $encryptedData);
    }

    static public function State($state) {
    ...
    static public function RetryDelay($retryDelay) {
        return self::Base(TLVType::RetryDelay, pack("N", $retryDelay));
    }

    static public function Certificate($certificate) {
        return self::Base(TLVType::Certificate, $certificate);
    }

    static public function Signature($signature) {
        return self::Base(TLVType::Signature, $signature);
    }

    static public function Permissions($permissions) {
        return self::Base(TLVType::Permissions, Chr($permissions));
    }

    static public function Seperator() {
