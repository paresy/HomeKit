...
include_once "../HomeKitBridge/srp.php";
...
class SRP6aServerTest extends TestCase
{
    public function testGeneration(): void
    {
        ...
        $Bverify = str_replace(" ", "", $Bverify);
        $Bverify = str_replace("\n", "", $Bverify);
        $Bverify = str_replace("\r", "", $Bverify);
        $Bverify = hex2bin($Bverify);
        ...
        $Averify = str_replace(" ", "", $Averify);
        $Averify = str_replace("\n", "", $Averify);
        $Averify = str_replace("\r", "", $Averify);
        $Averify = hex2bin($Averify);
        ...
        $Sverify = str_replace(" ", "", $Sverify);
        $Sverify = str_replace("\n", "", $Sverify);
        $Sverify = str_replace("\r", "", $Sverify);
        $Sverify = hex2bin($Sverify);
        ...
        $Kverify = str_replace(" ", "", $Kverify);
        $Kverify = str_replace("\n", "", $Kverify);
        $Kverify = str_replace("\r", "", $Kverify);
        $Kverify = hex2bin($Kverify);
