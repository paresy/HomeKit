...
class HomeKitHumiditySensorTest extends HomeKitBaseTest
{
    public function testAccessory(): void
    {
        ...
        IPS_SetProperty($bridgeID, 'AccessoryHumiditySensor', json_encode([
            [
                'ID'         => 3,
                'Name'       => 'Test',
                'VariableID' => $vid
        ...
        $accessory = json_decode(file_get_contents(__DIR__ . '/exports/HumiditySensor.json'), true);
