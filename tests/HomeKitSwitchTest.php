...
class HomeKitSwitchTest extends HomeKitBaseTest
{
    public function testAccessory(): void
    {
        ...
        IPS_SetProperty($bridgeID, 'AccessorySwitch', json_encode([
            [
                'ID'         => 2,
                'Name'       => 'Test',
                'VariableID' => $vid
        ...
        $accessory = json_decode(file_get_contents(__DIR__ . '/exports/Switch.json'), true);
